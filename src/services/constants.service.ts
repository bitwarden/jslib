export class ConstantsService {
    ...
    static readonly enableAutoTotpCopyOnAutoFill: string = 'enableAutoTotpCopyOnAutoFill';
    ...
    readonly enableAutoTotpCopyOnAutoFill: string = ConstantsService.enableAutoTotpCopyOnAutoFill;
