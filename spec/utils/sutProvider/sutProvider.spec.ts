...
import { TestSut, UndecoratedSut } from "./testSut.service";
...
describe("SutProvider", () => {
  ...
  it("throws an error if the class doesn't have a decorator", () => {
    expect(() => new SutProvider(UndecoratedSut)).toThrowError(/No class metadata found.*/);
  });
});
