...
describe("WebCrypto Function Service", () => {
    describe("pbkdf2", () => {
        ...
        const regular512Key =
            "liTi/Ke8LPU1Qv+Vl7NGEVt/XMbsBVJ2kQxtVG/Z1/JFHFKQW3ZkI81qVlwTiCpb+cFXzs+57" + "eyhhx5wfKo5Cg==";
        const utf8512Key =
            "df0KdvIBeCzD/kyXptwQohaqUa4e7IyFUyhFQjXCANu5T+scq55hCcE4dG4T/MhAk2exw8j7ixRN" + "zXANiVZpnw==";
        const unicode512Key =
            "FE+AnUJaxv8jh+zUDtZz4mjjcYk0/PZDZm+SLJe3XtxtnpdqqpblX6JjuMZt/dYYNMOrb2+mD" + "L3FiQDTROh1lg==";
    ...
    describe("hkdfExpand", () => {
        ...
        const prk64Byte =
            "ssBK0mRG17VHdtsgt8yo4v25CRNpauH+0r2fwY/E9rLyaFBAOMbIeTry+" + "gUJ28p8y+hFh3EI9pcrEWaNvFYonQ==";
        ...
        testHkdfExpand(
            ...
            prk32Byte,
            64,
            "BnIqJlfnHm0e/2iB/15cbHyR19ARPIcWRp4oNS22CD9BV+" + "/queOZenPNkDhmlVyL2WZ3OSU5+7ISNF5NhNfvZA=="
        );
        ...
        testHkdfExpand(
            ...
            prk64Byte,
            64,
            "uLWbMWodSBms5uGJ5WTRTesyW+MD7nlpCZvagvIRXlkY5Pv0sB+" + "MqvaopmkC6sD/j89zDwTV9Ib2fpucUydO8w=="
        );
...
function getWebCryptoFunctionService() {
    ...
    platformUtilsMock
        .isIE()
        .mimicks(() => navigator.userAgent.indexOf(" Edg/") === -1 && navigator.userAgent.indexOf(" Trident/") !== -1);
